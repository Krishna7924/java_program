...
public class BufferedOutputStreamDemo {
    public static void main(String args[]) {
        ...
        try {
            // FileOutputStream fou = new FileOutputStream("Hello.txt");//to replace old data in file
            FileOutputStream fou = new FileOutputStream("Hello.txt",true);//to append in data at file
